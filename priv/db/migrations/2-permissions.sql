...
INSERT INTO service_user (email, created_on)
       VALUES ('root@hxgm30.mush', current_timestamp);

INSERT INTO game (id, display_name, created_on, status)
       VALUES (1, 'The Game of MUSH', current_timestamp, 'created');

INSERT INTO game_character (owner, game_id, role, display_name, created_on)
       VALUES ('root@hxgm30.mush', 1, 'player', 'Myka', current_timestamp);
INSERT INTO game_character (owner, game_id, role, display_name, created_on)
       VALUES ('root@hxgm30.mush', 1, 'moderator', 'Hartig', current_timestamp);
INSERT INTO game_character (owner, game_id, role, display_name, created_on)
       VALUES ('root@hxgm30.mush', 1, 'builder', 'Hyphay', current_timestamp);
INSERT INTO game_character (owner, game_id, role, display_name, created_on)
       VALUES ('root@hxgm30.mush', 1, 'admin', 'Basidia', current_timestamp);
INSERT INTO game_character (owner, game_id, role, display_name, created_on)
       VALUES ('root@hxgm30.mush', 1, 'wizard', 'Psilofyr', current_timestamp);
